...
export const esMx: Messages = {
  ...
  adminOrders: {
    ...
    statusFilterLabel: "Estado del pedido",
    statusAll: "Todos los pedidos retenidos",
    statusActive: "Todos los pedidos activos",
    searchLabel: "Buscar pedidos",
    searchPlaceholder: "Pedido, cliente, teléfono, bebida o sabor",
    fromDateLabel: "Pedidos desde",
    ...
    pageSummary: "Página {{page}} de {{totalPages}} · {{totalItems}} pedidos",
    previous: "Anterior",
    next: "Siguiente",
    ...
    lastChangedBy: "Último cambio por {{name}} · {{time}}",
  },
  staff: {
    title: "Personal",
    description: "Crea cuentas con nombre y revoca el acceso de una persona sin cerrar la sesión de todos.",
    addTitle: "Agregar miembro del personal",
    ...
    cancel: "Cancelar",
    loadFailed: "No se pudieron cargar las cuentas del personal.",
    createFailed: "No se pudo crear la cuenta del personal.",
    updateFailed: "No se pudo actualizar la cuenta del personal.",
    passwordResetFailed: "No se pudo restablecer la contraseña.",
    created: "Cuenta del personal creada.",
    disabled: "Cuenta del personal deshabilitada.",
    enabled: "Cuenta del personal habilitada.",
    passwordReset: "Contraseña restablecida. Las sesiones existentes fueron revocadas.",
  },
  account: {
    title: "Mi cuenta",
    ...
    newPassword: "Nueva contraseña",
    passwordHelp: "Usa al menos 12 caracteres con mayúsculas, minúsculas, un número y un símbolo.",
    savePassword: "Cambiar contraseña",
    saving: "Guardando…",
    passwordChanged: "Contraseña cambiada. Las demás sesiones de esta cuenta se cerraron.",
