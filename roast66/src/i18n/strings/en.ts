...
export const en = {
  ...
  home: {
    ...
    featuredEyebrow: "Made for the road",
    featuredTitle: "Featured specials",
    featuredBody:
      "A few current favorites from the trailer. Specials can change, so check the full menu before you order.",
    featuredEmpty: "Fresh specials are on the way. See the full menu for today's drinks.",
  ...
  adminMenu: {
    ...
    featureOnHome: "Feature this item on the homepage (up to three shown)",
