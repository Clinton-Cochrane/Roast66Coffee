...
export const en = {
  ...
  adminOrders: {
    ...
    statusAll: "All retained orders",
    statusActive: "All active orders",
    searchLabel: "Search orders",
    searchPlaceholder: "Order, customer, phone, drink, or flavor",
    fromDateLabel: "Ordered from",
    ...
    pageSummary: "Page {{page}} of {{totalPages}} · {{totalItems}} orders",
    previous: "Previous",
    next: "Next",
    ...
    lastChangedBy: "Last changed by {{name}} · {{time}}",
  },
  staff: {
    title: "Staff",
    description: "Create named accounts and revoke one person's access without signing everyone out.",
    ...
    createFailed: "Could not create the staff account.",
    updateFailed: "Could not update the staff account.",
    passwordResetFailed: "Could not reset the password.",
    created: "Staff account created.",
    disabled: "Staff account disabled.",
    enabled: "Staff account enabled.",
    passwordReset: "Password reset. Existing sessions were revoked.",
  },
  account: {
    title: "My account",
    ...
    newPassword: "New password",
    passwordHelp: "Use at least 12 characters with upper- and lowercase letters, a number, and a symbol.",
    savePassword: "Change password",
    saving: "Saving…",
    passwordChanged: "Password changed. Other sessions for this account have been signed out.",
  ...
  adminMenu: {
    ...
    editDescription: "Update this item or manage its availability.",
    nameLabel: "Name",
    ...
    deleteHelp: "Permanent deletion removes {{name}} from the menu. Historical orders remain intact.",
    deleteConfirmationLabel: "Type {{name}} to confirm permanent deletion",
    ...
    failedArchive: "Failed to archive menu item",
    failedRestore: "Failed to restore menu item",
  ...
  adminBulk: {
    ...
    importConfirm:
      "Replace the current menu with {{count}} imported items? Historical orders will remain intact, but this cannot restore the current menu.",
