...
function Menu() {
  ...
  const groupedItems = {
    ...
    Specials: menuItems.filter((item) => item.categoryType === CategoryType.SPECIALS),
    Flavors: menuItems.filter((item) => item.categoryType === CategoryType.FLAVORS),
  };
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="w-full max-w-5xl mx-auto">
        ...
        <p className="text-center r66-subtitle mb-8">Rustic coffee classics and roadtrip-ready favorites.</p>
