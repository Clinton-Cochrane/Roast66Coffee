...
namespace CoffeeShopApi.Migrations
{
    ...
    [Migration("20260907055320_EnforceOrderQuantityBounds")]
    partial class EnforceOrderQuantityBounds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeeShopApi.Models.AddOn", b =>
                {
                    ...
                    b.ToTable("addons", t =>
                        {
                            t.HasCheckConstraint("ck_addons_quantity_range", "quantity >= 1 AND quantity <= 12");
                        });
                });

            modelBuilder.Entity("CoffeeShopApi.Models.AuditEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("EntityType", "EntityId", "Action", "OccurredUtc")
            ...
            modelBuilder.Entity("CoffeeShopApi.Models.OrderItem", b =>
                {
                    ...
                    b.ToTable("orderitems", t =>
                        {
                            t.HasCheckConstraint("ck_orderitems_quantity_range", "quantity >= 1 AND quantity <= 12");
                        });
                });
            ...
            modelBuilder.Entity("CoffeeShopApi.Models.StaffUser", b =>
                {
            ...
            modelBuilder.Entity("CoffeeShopApi.Models.StaffPushSubscription", b =>
                {
                    b.HasOne("CoffeeShopApi.Models.StaffUser", "StaffUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CoffeeShopApi.Models.StaffUser", null)
                        .WithMany()
